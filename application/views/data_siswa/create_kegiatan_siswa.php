                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo site_url('data_siswa/kegiatan_siswa_save')?>" method="post" class="form-horizontal"> 
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <input type="text" class="form-control" name= "tanggal_mulai" placeholder="tanggal masuk">
                        </div>
                        <div class="form-group">
                        <label class="col-sm-2 control-label"> Tanggal keluar </label>
                        <div class="col-xs-2">
                            <input type="text" class="form-control" name= "tanggal_selesai" placeholder="tanggal selesai">
                        </div>
                        </div>
                    <div class="form-group">
