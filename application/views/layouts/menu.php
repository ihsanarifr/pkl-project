...
else
{
    ...
    <!--Administrator-->
        <ul class="nav navbar-nav">
        <li class="active"><a href="<?php echo site_url('home')?>"><i class="glyphicon glyphicon-home"></i> Beranda</a></li>
        <li><a href="<?php echo site_url('data_siswa')?>"><i class="glyphicon glyphicon-user"></i> Data Siswa</a></li>
        <li class="dropdown">
    ...
    <ul class="nav navbar-nav">
        ...
        <li><a href="<?php echo site_url('penilaian')?>"><i class="glyphicon glyphicon-thumbs-up"></i>  Penilaian</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
    ...
    <ul class="nav navbar-nav">
        <li class="active"><a href="<?php echo site_url('home')?>"><i class="glyphicon glyphicon-home"></i> Beranda</a></li>
        <li><a href="<?php echo site_url('data_siswa')?>"><i class="glyphicon glyphicon-thumbs-up"></i>  Data Siswa</a></li>
        <li><a href="<?php echo site_url('penilaian')?>"><i class="glyphicon glyphicon-thumbs-up"></i>  Penilaian</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
        <li><a href="<?php echo base_url() ?>profile/<?php echo $this->ion_auth->user()->row()->id ?>"><i class="glyphicon glyphicon-user"></i> <?php echo $this->ion_auth->user()->row()->first_name ?></a></li>
